...
{
    lv_style_transition_dsc_init(&slider_trans_dsc, slider_props, lv_anim_path_linear,
                                 300, 0, NULL);
...
lv_obj_t *lcd_create_slider(lv_obj_t *parent, int16_t min_value, int16_t max_value,
